...
class SileroVadOnnxModel(modelBytes: ByteArray): AutoCloseable {
...
//        opts.addCPU(true)
    ...
    fun call(x: Array<FloatArray?>, sr: Int): FloatArray {
        ...
        try {
            ...
            h = ortOutputs[1].value as Array<Array<FloatArray>>
            c = ortOutputs[2].value as Array<Array<FloatArray>>
