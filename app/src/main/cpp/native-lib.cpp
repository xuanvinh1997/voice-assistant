...
namespace {
    void ThrowException(JNIEnv *env, OgaResult *result) {
        ...
        static const char *className = "ai/assistant/llm/GenAIException";
...
Java_ai_assistant_llm_GenAIWrapper_releaseModel(JNIEnv *env, jobject thiz, jlong native_model) {
    auto* model = reinterpret_cast<OgaModel*>(native_model);
    OgaDestroyModel(model);
}

extern "C" JNIEXPORT jlong JNICALL
Java_ai_assistant_llm_GenAIWrapper_createTokenizer(JNIEnv *env, jobject thiz, jlong native_model) {
...
extern "C" JNIEXPORT void JNICALL
Java_ai_assistant_llm_GenAIWrapper_releaseTokenizer(JNIEnv *env, jobject thiz, jlong native_tokenizer) {
